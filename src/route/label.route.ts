...
import { createLabelHandler, deleteLabelHandler, getLabelHandler, getLabelsByBoardHandler, updateLabelHandler } from '../controller/label.controller';
...
labelRouter.get('/get-label/:id', getLabelHandler);
